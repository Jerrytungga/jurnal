    ...
    <div class="modal-dialog" id="modal-edit">
        <div class="modal-content">
            <form action="" method="POST" class="form-inline">
                ...
                <button onclick="return confirm('Anda Yakin akan menghapus data?');" hidden name="hapus" id="hapus" class="btn btn-danger"><i class="fas fa-trash"></i></button>
            </form>
        </div>
    </div>
</div> -->
...
<div class="modal fade" id="hapus" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST">
                <div class="modal-body">
                    <h5>Are you sure you want to delete the data on the date <?= $row["date"]; ?> ?</h5>
                    <input type="hidden" name="nis" value="<?= $row["nis"]; ?>">
                    <input type="hidden" name="date" value="<?= $row["date"]; ?>">
                </div>
                <div class="modal-footer">
