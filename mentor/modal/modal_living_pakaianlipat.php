<!-- Modal livingpakain-->
<div class="modal fade" id="pakaianlipat" tabindex="-1" aria-labelledby="Buku" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title font-weight-bold" id="Buku">Pakaian Lipat</h5>
...
<!-- Modal edit penilaian Pakaian Lipat-->
<div class="modal fade" id="edit" tabindex="-1" aria-labelledby="Buku" aria-hidden="true">
  <div class="modal-dialog" id="modal-edit">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title font-weight-bold" id="Buku">Edit Penilaian Pakaian Lipat</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
