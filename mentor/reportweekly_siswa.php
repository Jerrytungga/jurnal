...
$siswa = mysqli_query($conn, "SELECT * FROM siswa a JOIN tb_angkatan b ON a.angkatan= b.angkatan WHERE status='Aktif' and mentor='$id' ORDER BY a.date DESC;");
                    ...
                    <div class="row mt-2 mb-4">
                        <div class="col">
                            <form action="cetak.php" target="blank" method="POST" class="form-inline">
                                ...
                                <button type="submit" name="filter_tanggal" class="btn btn-info ml-3">Cetak Laporan</button>
